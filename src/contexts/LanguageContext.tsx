...
const translations = {
  ...
  ml: {
    ...
    'services.kuri.description': 'മുകുന്ദപുരം കുരിയിൽ, പരമ്പരാഗത ചിട്ടി സംവിധാനത്തിന്റെ വിശ്വാസം ആധുനിക സേവനസൗകര്യങ്ങളുമായി സംയോജിപ്പിച്ചിരിക്കുന്നു. എല്ലാ തരം നിക്ഷേപകർക്കും അനുയോജ്യമായ, ലളിതമായ ചിട്ടി പദ്ധതികളിലൂടെ നിങ്ങൾക്ക് നിങ്ങളുടെ ആവശ്യങ്ങൾക്കും ഭാവി പദ്ധതികൾക്കും വേണ്ടിയുള്ള ധനസഹായം ലഭ്യമാക്കുന്നു.',
